...
struct GameState {
    ...
    InsuranceType insurances[3] = {
        {"Home Insurance", 0, 1000000, 15000, 15000, 1000000, 12, 0, 40},
        {"Car Insurance", 0, 1000000, 15000, 15000, 1000000, 12, 0, 35},
        {"Health Insurance", 0, 1000000, 15000, 15000, 1000000, 12, 0, 25}
    };
